...
# Repository: projects/anl2025
echo -e "${BLUE}Restoring: projects/anl2025${NC}"
if [ -d "projects/anl2025/.git" ]; then
    ...
    if git clone "git@github.com:autoneg/anl2025.git" "projects/anl2025"; then
