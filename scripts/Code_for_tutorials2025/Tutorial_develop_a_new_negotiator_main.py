...
from anl2025 import make_multideal_scenario, run_session, anl2025_tournament, Boulware2025, Linear2025, Random2025
...
def run_a_session_with_template_agent():
    ...
    results = run_session(center_type = NewNegotiator, edge_types = competitors, scenario = scenario)
    print(f"Center Utility: {results.center_utility}\nEdge Utilities: {results.edge_utilities}")
